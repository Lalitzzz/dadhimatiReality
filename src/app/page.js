...
export default function Home() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* New Section for First Image (Site Plan) */}
     {/* <div className="max-w-4xl mx-auto mt-10 p-6 shadow-2xl border border-gray-200 rounded-2xl bg-gradient-to-r from-orange-50 to-yellow-100">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-red-600 mb-2">Jaipur Development Authority</h2>
        ...
        <h3 className="text-2xl font-bold text-orange-600 mt-4">Commercial Plots</h3>
        <p className="text-md font-medium text-gray-700 mt-2">
          A golden opportunity to buy plots at a low budget in \"today's time\"
        </p>
      </div>

      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-gray-800">
        <div className="bg-white p-4 rounded-xl shadow-md">
          <p>Just 10 minutes from Bombay Hospital, Jagatpura</p>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-md">
          <p>Only 10 minutes away from JECRC College, Poornima College</p>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-md">
          <p>Only 1 minute from IIS World University</p>
        </div>
      </div>
      ...
      <div className="mt-8 text-center">
        ...
        <div className="flex justify-center items-center gap-2">
          ...
          <span className="text-blue-600 font-medium">Phone number here</span>
        </div>
      </div>
    </div> */}
